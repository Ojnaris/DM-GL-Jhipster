...
public class Role implements Serializable {
    ...
    public UserAccount getRolesUser() {
        return rolesUser;
    }

    public Role rolesUser(UserAccount userAccount) {
        this.rolesUser = userAccount;
        return this;
    }

    public void setRolesUser(UserAccount userAccount) {
        this.rolesUser = userAccount;
    }
