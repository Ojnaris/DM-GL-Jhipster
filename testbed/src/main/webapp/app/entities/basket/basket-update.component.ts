...
export class BasketUpdateComponent implements OnInit {
  ...
  updateForm(basket: IBasket): void {
    this.editForm.patchValue({
      ...
      basketsD: basket.basketsD,
      basketsC: basket.basketsC,
      basketsR: basket.basketsR
    });
  }
  ...
  private createFromForm(): IBasket {
    return {
      ...
      basketsD: this.editForm.get(['basketsD'])!.value,
      basketsC: this.editForm.get(['basketsC'])!.value,
      basketsR: this.editForm.get(['basketsR'])!.value
    };
  }
